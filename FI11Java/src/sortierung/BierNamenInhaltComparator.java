...
public class BierNamenInhaltComparator implements Comparator<Bier>
{
	...
	public int compare(Bier bier1, Bier bier2)
	{
		...
		return bier1.getName().compareTo(bier2.getName()); //-1 heißt das zweite Objekt (bier2) ist übergeordnet, das zweite Element bei -1 ist kleiner , -1 bedeutet das zweite Objekt ist am Ende der Auflistung also unter Z, das erste Objekt ist bei -1 größer das zweite kleiner, -1 heißt das erste Element wird ans Ende gepusht. Von oben gesehen ist das Absteigend
	}
}
